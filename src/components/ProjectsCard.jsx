const ProjectCard = ({ p }) => {
  ...
  return (
    <a href={p.link} className="group relative flex flex-col gap-2 self-start rounded-md bg-gray-50 p-4 shadow-sm duration-200 hover:scale-[1.02]">
      <div className="relative h-28 w-full rounded-t-md bg-cover bg-center bg-no-repeat grayscale filter duration-200 group-hover:filter-none" style={{ backgroundImage: `url(${p.card_img_src})` }}>
