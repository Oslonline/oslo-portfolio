    ...
    <section className="flex w-full justify-center py-20">
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="flex gap-4 text-sm md:gap-8 md:text-base lg:gap-14">
          ...
          <a className="group flex translate-y-10 flex-col items-center gap-2 rounded-md bg-gray-50 p-2 shadow-sm duration-100 md:translate-y-5 md:hover:scale-105" href="https://x.com/Oslo418">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" className="h-16 md:h-20">
          ...
          <a className="group flex h-fit flex-col items-center gap-2 rounded-md bg-gray-50 p-2 shadow-sm duration-100 md:hover:scale-105" href="https://t.me/Oslo418">
            <svg className="h-12 fill-black md:h-14" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
