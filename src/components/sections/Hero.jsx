...
export default function Hero() {
  return (
    <section className="flex h-screen items-center justify-center">
      <div className="flex w-fit flex-col-reverse items-center p-2 mb-16 md:flex-row">
        <div className="text-center md:text-start">
          <h1 className="font-mono text-6xl font-extrabold md:text-8xl lg:text-9xl">Oslo418</h1>
          <p className="pl-3 text-lg font-semibold md:text-2xl">Cyber enthusiast, devweb on track !</p>
        </div>
        <div className="max-h-fit max-w-fit">
          <svg className="h-48 w-48 fill-transparent stroke-zinc-950 stroke-[10px] md:h-72 md:w-72 lg:h-80 lg:w-80" version="1.1" viewBox="0 0 350 350">
            <motion.path
