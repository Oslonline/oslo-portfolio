...
export default function Hero() {
  return (
    <section className="flex h-screen items-center justify-center">
      <div className="flex w-fit flex-col-reverse items-center mb-16 md:flex-row">
        ...
        <div className="max-h-fit max-w-fit">
          <svg className="fill-transparent stroke-zinc-950 stroke-[10px] h-72 =w-72 lg:h-80 lg:w-80" version="1.1" viewBox="0 0 350 350">
            <motion.path
